public class ListAndStrings {
    ...
    // public static largestElementInList() takes list of Integers and returns largest Integer in a list.


    //2. Write function that reverses a list, preferably in place.
    // public static reversedList() takes a list of any type and returns reversed one.


    //3. Write a function that checks whether an element occurs in a list.
    // public static elementOccurrence() takes a list and element and
    // then returns whether element is contained in list (true) or not (false)

    //4. Write a function that returns the elements on odd positions in a list.
    // public static oddPositionsList() takes list and returns list with elements from 1,3,5,7,... positions
    // Remember that first element has index 0&


    //5. Write a function that computes the running total of a list.
    // public static runningTotal() takes a list of Integers and returns list of calculated elements


    //6. Write a function that tests whether a string is a palindrome.
    // public static isPalindrome() takes a string and returns true if sti
